...
// }
void FullAutomaticClusterCreator::initCluster(AbstractWolffArray2d& spinMatrix, std::mt19937& rng) 
{
...
void FullAutomaticClusterCreator::createCluster(AbstractWolffArray2d& spinMatrix, std::mt19937& rng, float temperature)
{
